...
public interface SurveyApi {
    ...
    List<ItemDto> survey(@ApiParam(value = "PlantLocation[backyard,balcony,rooftop,indoors] PlantType[fruits,herbs,house,succulent,vegetable]", required = true) @RequestBody NewSurveyDto request);
